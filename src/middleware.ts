...
const roleBasedRoutes = {
  ...
  ADMIN: [/^\/create-post/, /^\/change-password/, /^\/profile-seetings/, /^\/add-category/, /^\/my-profile/, /^\/verify-account/, /^\/dashboard/], // must you have admin to access this routes
}
...
export const config = {
  matcher: ['/create-post', '/login', '/register', '/change-password', '/profile-seetings', '/add-category', '/my-profile', "/verify-account", "/dashboard"]
}